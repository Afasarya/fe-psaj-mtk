...
const Hero = () => {
  return (
    <section className="relative min-h-screen bg-gradient-to-b from-[#dfedfa] via-[#f0f7fc] to-white font-jakarta">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-[33vh]">
        {/* Main Hero Content */}
        <div className="pt-32 sm:pt-40 md:pt-48 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-20">
            <Link
              href="/get-started"
              className="group bg-gray-900 text-white px-8 py-4 rounded-full hover:bg-gray-800 transition-all duration-200 font-medium text-lg inline-flex items-center gap-2"
            >
              Start Planning Now
          ...
          {/* Stats Section */}
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-20">
